...
class Object3d(object):
  ...
  def get_diff(self,obj):
    ...
    res[0] = abs(self.alpha - obj.alpha)
 
    res[1] = abs(self.xmin - obj.xmin  )
    res[2] = abs(self.ymin - obj.ymin  )
    res[3] = abs(self.xmax - obj.xmax   )
    res[4] = abs(self.ymax - obj.ymax )
    res[5] = abs(self.height - obj.height )
    res[6] = abs(self.width - obj.width )
    res[7] = abs(self.length - obj.length) 
