...
def parse_args():
    ...
    parser.add_argument(
        '--config-file', help="Name of the configuration to use without extension", default='/content/DiffusionDetLidar/configs/diffdetbev.coco.res50', type=str)
    parser.add_argument(
        '--ann_val', help="Validation file with the annotations in COCO format previously generated by the training script, without extension", default='/content/DiffusionDetLidar/datasets/bv_kitti/annotations/training_annotations_kitti_carpedcyc_RDHCVPr12', type=str)
    parser.add_argument(
